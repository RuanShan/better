...
function BetterFinancialPanelPlus() {
  var o = {
    ...
    setHistoryToChart: function(a, b) {
        ...
        f.getHistory(d, a, c, o.chartData.chartStates.periodPerCandle).then(function(a) {
            ...
            g.$broadcast("chartHistoryChanged", o.chartData.chartHistory, o.chartData.chartStates.precision)
        })
    },
  ...
  a.appInit = function(){
    ...
    a.chartObj = new Highcharts.StockChart(r(a.chartData, a.precision, a.chartType)),
