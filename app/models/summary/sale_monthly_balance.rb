module Summary
  ...
  class SaleMonthlyBalance
    ...
    def initialize( effective_on, user_months =[] )
      ...
      self.profit , self.bid_amount , self.energetic_member_count = 0, 0, 0
    ...
    def self.generate_csv(monthly_balances, options = {})
      CSV.generate(options) do |csv|
        ...
        monthly_balances.each do |monthly_balance|
          csv << [monthly_balance.effective_on.to_s(:year_month), monthly_balance.energetic_member_count, monthly_balance.profit, monthly_balance.bank_charges,
